...
$(function(){
	...
	$("#avoidand-personality-therapies").load("/illnesses/treatments/therapies/avoidand_personality.html");
	...
	$("#depressive-identity-therapies").load("/illnesses/treatments/therapies/depressive_identity.html");
	...
	$("#avoidand-personality-medications").load("/illnesses/treatments/medications/avoidand_personality.html");
	...
	$("#depressive-identity-medications").load("/illnesses/treatments/medications/depressive_identity.html");
	...
	$("#avoidand-personality-specialists").load("/illnesses/treatments/specialists/avoidand_personality.html");
	...
	$("#depressive-identity-specialists").load("/illnesses/treatments/specialists/depressive_identity.html");
